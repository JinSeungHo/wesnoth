	...
	: builder_frame_parameters()
{
	...
	base::image = cfg[frame_string + "image"];
	base::image_diagonal = cfg[frame_string + "image_diagonal"];
	base::image_mod = cfg[frame_string + "image_mod"];
	base::halo = cfg[frame_string + "halo"];
	base::halo_x = cfg[frame_string + "halo_x"];
	base::halo_y = cfg[frame_string + "halo_y"];
	base::halo_mod = cfg[frame_string + "halo_mod"];
	base::sound = cfg[frame_string + "sound"];
	base::text = cfg[frame_string + "text"];
	base::blend_ratio = cfg[frame_string + "blend_ratio"];
	base::highlight_ratio = cfg[frame_string + "alpha"];
	base::offset = cfg[frame_string + "offset"];
	base::submerge = cfg[frame_string + "submerge"];
	base::x = cfg[frame_string + "x"];
	base::y = cfg[frame_string + "y"];
	base::directional_x = cfg[frame_string + "directional_x"];
	base::directional_y = cfg[frame_string + "directional_y"];
	base::drawing_layer = cfg[frame_string + "layer"];
